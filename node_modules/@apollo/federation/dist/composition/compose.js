        ...
        for (let definition of typeDefsWithoutExternalFields.definitions) {
            ...
            if (graphql_1.isTypeDefinitionNode(definition)) {
                ...
                if (definitionsMap[typeName]) {
                    definitionsMap[typeName].push(Object.assign({}, definition, { serviceName }));
                }
                else {
                    definitionsMap[typeName] = [Object.assign({}, definition, { serviceName })];
                }
            }
                ...
                if (extensionsMap[typeName]) {
                    extensionsMap[typeName].push(Object.assign({}, definition, { serviceName }));
                }
                else {
                    extensionsMap[typeName] = [Object.assign({}, definition, { serviceName })];
                }
            }
        }
    }
        ...
        if (graphql_1.isObjectType(namedType)) {
            for (const field of Object.values(namedType.getFields())) {
                ...
                if (providesDirective &&
                    ...
                    field.federation = Object.assign({}, field.federation, { serviceName: baseServiceName, provides: utils_1.parseSelections(providesDirective.arguments[0].value.value) });
                }
            }
        }
